...
function CardCategories({categories}: CardCategoryProps) {
  return (
        <div className='border  flex  grid-cols-1 lg:grid-cols-2 h-[200px] bg-white" flex-col rounded-2xl overflow-hidden justify-between'>
          <header className='py-2 px-6  bg-indigo-900 text-white font-bold text-2xl'>{categories.name}</header>
